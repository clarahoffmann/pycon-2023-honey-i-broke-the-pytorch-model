"Train PyTorch models with different breakage"
import argparse
...
from train_utils import (
    generate_linear_dataloaders,
    generate_nonlinear_dataloaders,
    train_model,
)


def main() -> None:
    """Train models with different breakage"""
    ...
    parser.add_argument(
        "--data_type", type=str, choices=["linear", "nonlinear"], required=True
    )
    parser.add_argument("--break_activations", type=bool, default=False)
    parser.add_argument("--freeze_weights", type=bool, default=False)
    parser.add_argument("--freeze_bias", type=bool, default=False)
    parser.add_argument("--break_dataloader", type=bool, default=False)
    parser.add_argument("--weight_watcher", type=bool, default=False)
    ...
    logger.info(
        f"... finished and written to reformatted_metrics/{output_path}"
    )
